class HTMLBlocks {
  static const String customHTMLBlock = '''
<p>
 ...
 ''';
  ...
  static const String problemBlock = '''
<problem parent_sequential_url="i4x://edX/DemoX/sequential/workflow" index_in_children_list="5">
  ...
  <p>Questions which are part of assignments or exams may have due dates - the last possible time you can submit an assignment for grading. Once this time has passed, you will not be able to get credit for any >
  <p>If an assignment has a due date, you can see the due date in the sidebar. (This demo course does not have any assignments with due dates.) If no due date is displayed, the assignment can be turned in at an>
  <p>All assignment due dates are displayed in the time zone that you select in your account settings. If you do not specify a time zone, assignment due dates display in your browser's time zone.</p>
  <h1/>
  ...
  <choiceresponse>
    <checkboxgroup direction="vertical">
      ...
      <choice correct="true">none of the above</choice>
    </checkboxgroup>
  </choiceresponse>
  <solution>
    EdX does not accept any late assignments under any circumstances, so the answer is "none of the above".
  </solution>
</problem>
''';
}
